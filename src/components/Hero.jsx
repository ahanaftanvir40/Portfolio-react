...
function Hero() {
  ...
  return (
    <div
      id="about"
      className="container  mx-auto px-4 min-h-screen flex items-center bg-[#4f4b64] sm:rounded-3xl "
    >
      <div className="flex flex-col lg:flex-row justify-around items-center sm:mt-24 min-h-[40vh] space-y-5 lg:space-y-0 lg:space-x-10 w-full">
        <div className="flex flex-col justify-center items-center h-auto lg:h-[400px]">
          <div className="w-full lg:w-[80vh] h-auto lg:h-40vh">
            <motion.div
              initial={{ y: -1000 }}
              animate={{ y: [0, -10, 0] }}
              transition={{
            ...
            <div className="mt-6">
              <p className="about -mt-1 sm:mt-0  text-slate-300 text-center lg:text-left sm:text-3xl">
                Aspiring Full Stack Web Developer with a passion for creating
                dynamic and user-friendly websites. Proficient in MERN Stack,
                NextJs, JavaScript, and Python. Eager to leverage programming
                skills and enthusiasm for problem-solving to contribute to
              ...
              <div className="mt-4 flex justify-center items-center sm:justify-start sm:items-start">
                ...
                <a
                  href="https://www.linkedin.com/in/ahanaf-tanvir-980a06264/"
                  target="_blank"
                >
