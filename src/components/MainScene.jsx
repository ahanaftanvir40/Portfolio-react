...
function Scene() {
  ...
  window.addEventListener("mousemove", (e) => {
    const rotationX = (e.clientX / window.innerWidth - 0.5) * (Math.PI * 0.25);
    const rotationY = (e.clientY / window.innerHeight - 0.5) * (Math.PI * 0.25);
...
function MainScene() {
  ...
  return (
    <div className="flex flex-col items-center p-4 lg:px-14 sm:p-0 justify-center w-full h-screen">
      ...
      {/* Your content */}
      <div className="flex flex-col md:flex-col lg:flex-row items-center py-28 lg:justify-around md:justify-center w-full h-full z-10">
        <div>
          <motion.div
            initial={{ y: -1000 }}
            animate={{ y: [0, -10, 0] }}
          ...
          <div className="Intro mb-0 md:mb-0 md:mr-8 text-center md:text-left ">
            <h1 className="text-4xl">
              I am Ahanaf Tanvir, <span className="sm:hidden">a</span>{" "}
              <span className="text-[#b3cde4] sm:hidden">
                {" "}
                Full-Stack Web Developer
              </span>
              <h1 className="hidden sm:block">
                a{" "}
                <span className="text-[#b3cde4]">Full-Stack Web Developer</span>
              </h1>
            </h1>
          </div>
        </div>
